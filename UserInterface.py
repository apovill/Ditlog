...
#    that the user selects
    ...
    def displayClipMeta(self):
        ...
        for terms in selclipmetaargs:
            if len(selclipmeta[selclipmetaargs.index(terms)]) > 40:
                print terms+selclipmeta[selclipmetaargs.index(terms)][:40]+'...'
            print "{0:45}  ---  {1:45}".format(terms, selclipmeta[selclipmetaargs.index(terms)])
